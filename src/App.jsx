...
const App = () => {
  return (
    <>
    <section className="w-full h-full absolute top-0 left-0 bg-[#151312] z-50 flex md:hidden items-center justify-center roboto-condensed-regular"> <span className="text-red-600">NB:</span> &nbsp;Please use a larger screen, this site is not optimized for smaller screens.</section>
