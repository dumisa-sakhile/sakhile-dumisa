...
const Intro = () => {
  return (
    <>
      <h1
        data-aos="fade-up"
        className="protest-guerrilla-regular  uppercase  text-2xl md:text-8xl w-[60%] text-white">
        MERN Stack
      </h1>
      <h1
        data-aos="fade-up"
        className="protest-guerrilla-regular  uppercase text-2xl md:text-8xl w-[60%] text-[#998f8fdf]">
        Developer
      </h1>
