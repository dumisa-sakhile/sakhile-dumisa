...
const Profile = () => {
  return (
    <main className="relative w-[344px] h-[640px] bg-white rounded-lg flex flex-col items-center py-6 justify-start gap-10 overflow-hidden">
      ...
      <aside className="flex flex-col items-center justify-center w-[450px] h-[450px] border-8 border-dashed border-orange-700 rounded-full absolute -bottom-[90px] -left-50"></aside>
